...
<body class="bg-bg text-gray-100 font-sans min-h-screen flex flex-col">
    ...
    <main class="max-w-4xl mx-auto px-4 py-12 flex-1 w-full space-y-12">
        <div class="text-center">
            <h1 class="text-3xl font-bold text-font-biru">Layanan Pengaduan</h1>
        ...
        <div class="flex justify-center pt-4">
            ...
            <div class="bg-[#0f294a] rounded-xl p-6 border border-blue-900/40 shadow-md flex flex-col justify-between w-full max-w-3xl">
                ...
                <div class="flex justify-center text-center">
                    <!-- Tombol WhatsApp -->
                    <a href="https://wa.me/085187656263" target="_blank" class="bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs py-3 px-6 rounded-lg text-center transition tracking-wide shadow-md shadow-emerald-900/20">
